...
def conv_forward(A_prev, W, b, hparameters):
    ...
    for i in range(m):                               # loop over the batch of training examples
        ...
        for h in range(1,n_W):                           # loop over vertical axis of the output volume
            for w in range(1,n_H):                       # loop over horizontal axis of the output volume
                for c in range(1,n_C):                   # loop over channels (= #filters) of the output volume
...
def pool_backward(dA, cache, mode = "max"):
    ...
    for i in range(m):                       # loop over the training examples
        ...
        for h in range(n_W):                   # loop on the vertical axis
            for w in range(n_H):               # loop on the horizontal axis
