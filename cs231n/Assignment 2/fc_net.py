...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout2,w2,grads['b2'] = affine_backward(dscores,cache2)
        dout1,w1,grads['b1'] = affine_relu_backward(dout2,cache1)
        grads['W2'] = w2 + self.reg * self.params['W2']
        grads['W1'] = w1 + self.reg * self.params['W1']
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
